...
const Hire = lazy(() =>
  import("./pages/Hire").then((module) => ({ default: module.Hire })),
);
const Join = lazy(() =>
  import("./pages/Join").then((module) => ({ default: module.Join })),
);
const Admin = lazy(() =>
  import("./pages/Admin").then((module) => ({ default: module.Admin })),
);
const DrawingTeachers = lazy(() =>
  import("./pages/DrawingTeachers").then((module) => ({
    default: module.DrawingTeachers,
  })),
);
const WallMurals = lazy(() =>
  import("./pages/WallMurals").then((module) => ({
    default: module.WallMurals,
  })),
);
const EventsLiveArt = lazy(() =>
  import("./pages/EventsLiveArt").then((module) => ({
    default: module.EventsLiveArt,
  })),
);
const Collaborate = lazy(() =>
  import("./pages/Collaborate").then((module) => ({
    default: module.Collaborate,
  })),
);
const ArtistsDirectory = lazy(() =>
  import("./pages/ArtistsDirectory").then((module) => ({
    default: module.ArtistsDirectory,
  })),
);
const ArtistProfile = lazy(() =>
  import("./pages/ArtistProfile").then((module) => ({
    default: module.ArtistProfile,
  })),
);
const Showcase = lazy(() =>
