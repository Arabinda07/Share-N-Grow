  ...
  return (
    <div className="container mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
      <div className="text-center mb-12">
        <h1 className="text-3xl font-bold tracking-tight text-stone-900 sm:text-4xl">Find a drawing teacher for your child.</h1>
      ...
      <div className="grid gap-8 md:grid-cols-2 mb-12">
        <Card className="border-stone-200">
          <CardContent className="pt-6">
            <h3 className="font-semibold text-lg mb-3">What children can learn</h3>
        ...
        <Card className="border-stone-200">
          <CardContent className="pt-6">
            <h3 className="font-semibold text-lg mb-3">Class formats</h3>
            <ul className="list-disc list-inside text-stone-600 space-y-1">
              <li>Home visits</li>
      ...
      <div className="mb-12 rounded-lg bg-amber-50 p-6 border border-amber-200">
        ...
        <CardContent className="pt-6">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-4">
              <h3 className="font-semibold text-lg border-b border-stone-100 pb-2">Parent Details</h3>
              <div className="grid gap-4 sm:grid-cols-2">
                <div className="space-y-2">
                  <label className="text-sm font-medium text-stone-900">Parent Name *</label>
            ...
            <div className="space-y-4 pt-4">
               <h3 className="font-semibold text-lg border-b border-stone-100 pb-2">Location & Student</h3>
              <div className="grid gap-4 sm:grid-cols-2">
                <div className="space-y-2">
              ...
              <div className="space-y-2">
                 <label className="text-sm font-medium text-stone-900">Child's Age *</label>
                 <Input name="age" required placeholder="E.g. 7 years old" />
              </div>
            </div>

            <div className="space-y-4 pt-4">
               <h3 className="font-semibold text-lg border-b border-stone-100 pb-2">Class Preferences</h3>
               <div className="grid gap-4 sm:grid-cols-2">
                <div className="space-y-2">
                  <label className="text-sm font-medium text-stone-900">Preferred Class Mode *</label>
                  <select name="mode" required className="flex h-10 w-full rounded-md border border-stone-300 bg-white px-3 py-2 text-sm text-stone-900">
                ...
                <div className="space-y-2">
                  <label className="text-sm font-medium text-stone-900">Goal *</label>
                  <select name="goal" required className="flex h-10 w-full rounded-md border border-stone-300 bg-white px-3 py-2 text-sm text-stone-900">
               ...
               <div className="grid gap-4 sm:grid-cols-2">
                <div className="space-y-2">
                  <label className="text-sm font-medium text-stone-900">Preferred Days/Timing *</label>
                  <Input name="timing" required placeholder="E.g. Weekends morning" />
                </div>
                <div className="space-y-2">
                  <label className="text-sm font-medium text-stone-900">Monthly Budget (Optional)</label>
